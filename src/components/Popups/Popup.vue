...
<template>
    <div class="absolute top-0 left-0 w-full h-svh bg-black/50 z-[99]
        ...
        <div class="flex flex-col w-[calc(100%)-1rem] sm:w-xl lg:w-2xl h-auto sm:h-auto md:h-[60%] rounded-xl p-6 box-border bg-primary-300 absolute top-[50%] left-[50%] -translate-[50%] shadow-lg shadow-black border-[1px] border-txt-2/50 z-100
            ...
            <div class="*:mt-4 *:bg-txt-2 *:text-primary-400 *:font-semibold *:hover:scale-105 *:transition-all *:duration-100 *:w-36 *:h-12 *:rounded-xl *:cursor-pointer
                flex flex-row gap-6">
