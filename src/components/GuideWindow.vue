    ...
    <div class="w-full h-full overflow-y-auto">
        <div class="flex flex-col h-full max-w-3xl mx-auto py-12 box-border">
            ...
            <p>or, if you want to be able to connect every time without re-running this command each time, you can instead run
                this to persistently add this URL to Ollama's trusted origins: </p>
            <br>

            <pre class="my-2"><code class="hljs language-bash !my-2">setx OLLAMA_ORIGINS="{{ originUrl }}"</code></pre>
            <br>

            <p>After this, just open Ollama normally and you should be able to access it via this website.</p>
            ...
            <h4 class="text-xl pb-2 pt-4 flex flex-row items-center">Error: listen tcp &#60;ip&#62;:&#60;port&#62;: bind: Only one usage of each socket address (protocol/network address/port) is normally permitted.</h4>
