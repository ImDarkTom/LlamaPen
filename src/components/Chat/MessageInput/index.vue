    ...
    if (input.files) {
        for (const file of input.files) {
            ...
            logger.info(
                ...
                'Added file for upload',
                file,
                'files to upload list now',
                filesToUpload.value,
            );
        }
    }
...
<template>
    <div class="w-full flex justify-center">
        <div
            class="w-[calc(100%-1rem)] lg:w-3xl mx-4 mb-2 p-4 box-border flex flex-col items-center max-h-192 relative bg-base-800 rounded-2xl transition-all duration-dynamic shadow-elevation-1 hover:shadow-elevation-2 focus-within:shadow-elevation-3 hover:focus-within:shadow-elevation-3">
            <ChatMessageInputScrollToBottomButton />
            <div
                ref="messageInputRef"
                class="text-base-100 w-full box-border pb-8 text-base border-none outline-none resize-none max-h-48 overflow-y-auto wrap-break-word empty:before:content-[attr(data-placeholder)] empty:before:text-base-200/60"
            ...
            <div class="w-full max-h-16">
                <div
                    ...
                    :key="file.name"
                    class="inline-block h-full p-2 pb-3 relative">
                    <img
            ...
            <div class="relative flex flex-row gap-2 justify-between w-full">
                <div class="flex flex-row gap-2 overflow-x-auto w-full">
