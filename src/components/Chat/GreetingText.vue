...
<template>
    <div class="flex flex-col justify-center md:justify-end items-center w-full h-full md:h-2/5 mb-12">
        <span class="text-xl md:text-2xl font-medium">{{ getGreetingMessage() }},</span>
        <span class="text-2xl md:text-4xl font-semibold text-center text-base-100">What can I help you with?</span>
        <span class="pt-4 text-base-200/80 flex flex-wrap gap-1.5 justify-center">
            ...
            &middot;
            <a
                :href="`https://github.com/ImDarkTom/LlamaPen/tree/${commitHashFull}`"
                target="_blank">
                <span
                    :title="commitHashFull"
                    class="bg-base-800/80 hover:bg-base-700 p-2 px-3 rounded-full box-content hover:text-base-100 cursor-pointer transition-colors duration-dynamic">
