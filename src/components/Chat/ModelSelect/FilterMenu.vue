...
<template>
    <div
        ...
        <div class="flex flex-col justify-end">
            <button
                class="bg-base-600 hover:bg-base-500 active:bg-base-400 p-2 rounded-md cursor-pointer outline-0 transition-colors duration-dynamic"
        ...
        <label class="flex flex-col">
            ...
            <UIMultiItemSelect
                ...
                button-class="bg-base-600 hover:bg-base-500 w-full p-2 rounded-md cursor-pointer outline-0 line-clamp-1 transition-colors duration-dynamic"
                menu-class="bg-base-600 w-full min-w-fit p-1 rounded-md outline-0 max-h-48 overflow-y-auto shadow-elevation-3"
                item-class="p-1 rounded-md hover:bg-base-500 active:scale-98 not-last:mb-1"
        ...
        <label class="flex flex-col">
            ...
            <select
                v-model="orderBy"
                ref="orderBySelect"
                class="bg-base-600 hover:bg-base-500 p-2 rounded-md cursor-pointer outline-0 transition-colors duration-dynamic">
